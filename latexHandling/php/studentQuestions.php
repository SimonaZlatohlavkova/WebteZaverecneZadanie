...
<body>
    ...
    <div class="container-fluid centered-container " id="questionsFlex">
            ...
            <div class="card-body">
                ...
                <div>
                    <form method="POST" action="select-file.php">
                        ...
                        <button type="submit" class="btn btn-success">Generovať príklad</button>
                    </form>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Prehľad príkladov</h5>
                <?php
                foreach ($studentQuestions as $studentQuestion) {
                    echo "<div class='questionName'>" . $studentQuestion['question_name'] . "</div>";
